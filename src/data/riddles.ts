...
export const hobbitRiddles: Riddle[] = [
  ...
  {
    id: '12',
    question: 'Я народжуюся в тиші, але можу змінити хід подій. Мене не видно, та мене чують усі.',
    options: ['Обіцянка', 'Подих', 'Думка', 'Слово'],
    correctIndex: 3,
  },
  {
    id: '13',
    question: 'Я веду тебе вперед, але не показую кінця. Я є скрізь, та мене не можна забрати з собою.',
    options: ['Завтра', 'Сонце', 'Дорога', 'Вода'],
    correctIndex: 2,
  },
  {
    id: '14',
    question: 'Я маю міста, але не маю будинків. Маю ліси, але не маю дерев. Маю воду, але не маю риби. Що я?',
  ...
  },
  {
    ...
    options: ['Роса', 'Зірка', 'Сон', 'Місяць'],
    correctIndex: 1,
  },
  {
    id: '19',
    question: 'Я з’являюся без стуку, живу лише мить, і зникаю, залишаючи слід у серці.',
    options: ['Спогад', 'Сльоза', 'Сон', 'Усмішка'],
    correctIndex: 2,
  },
  {
    id: '20',
    question: 'Я починаюся з кроку, але не маю ніг. Я можу тривати життя, або закінчитися миттю.',
    options: ['Пригода', 'Рішення', 'Випадок', 'Вчинок'],
    correctIndex: 0,
  },
  {
    id: '21',
    ...
    options: ['Темрява', 'Вода', 'Доля', 'Природа'],
    correctIndex: 0,
  },
  {
    id: '22',
